      ...
      <div className="section no-pad-bot" id="index-banner">
        <div className="container">
          <div className="row center">
            ...
            <Typography variant="body1" className={styles.statement} >{t('Get your soil analysis today')}</Typography>
            <Typography variant="body1" className={styles.statement} >{t('Increase your predictability and crop yields')}</Typography>
